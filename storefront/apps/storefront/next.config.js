...
const nextConfig = withNextIntl({
  redirects: async () => {
    return [
      // Redirect legacy English paths to our new region-specific paths
      {
        source: "/en",
        destination: "/",
        permanent: true,
      ...
      // Redirect legacy US paths to our Netherlands (default) paths
      {
        source: "/us/en",
        destination: "/",
        permanent: true,
      ...
      // Add redirects for our region-specific domains
      {
        source: "/nl",
        destination: "/",
        permanent: true,
